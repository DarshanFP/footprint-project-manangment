  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const req = {
        ...
        health_status_of_father: !e.target.fatherHealthStatus?"NA":e.target.fatherHealthStatus.value,
        health_status_of_father_others: e.target.fatherHealthStatusOthers
          ? e.target.fatherHealthStatusOthers.value
          : "NA",
        health_status_of_mother: !e.target.motherHealthStatus?"NA":e.target.motherHealthStatus.value,
